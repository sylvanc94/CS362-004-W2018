...
int effectSmithy(int handPos, struct gameState *state) {
	...
	discardCard(handPos, currentPlayer, state, 1);  /* bug introduced here */
...
int effectMine(int handPos, int choice1, int choice2, struct gameState *state) {
	int i;
	int j;
	int currentPlayer = whoseTurn(state);
...
int effectRemodel(int handPos, int choice1, int choice2, struct gameState *state) {
	int i;
	int j;
	int currentPlayer = whoseTurn(state);
	...
	//discard card from hand
	//discardCard(handPos, currentPlayer, state, 0);  /* bug introduced here */
...
int effectCutpurse(int handPos, struct gameState *state) {
	int i;
	int j;
	int k;
	int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case mine:
		return effectMine(handPos, choice1, choice2, state);

	case remodel:
		return effectRemodel(handPos, choice1, choice2, state);

	case smithy:
		return effectSmithy(handPos, state);
	...
	case cutpurse:
		return effectCutpurse(handPos, state);
